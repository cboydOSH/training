({
   ...
   urlEvent.setParams({
      "url": "/apex/vlocity_ins__OmniScriptUniversalPage?id={0}&layout=newport#/OmniScriptType/OSH/OmniScriptSubType/Enroll/OmniScriptLang/English/ContextId/{0}/PrefillDataRaptorBundle//true"
   });
