...
import { OMNIDEF } from './communityMemberPortalAdditionalInfoIframesEnglish_def.js';
import tmpl from './communityMemberPortalAdditionalInfoIframesEnglish.html';
import tmpl_nds from './communityMemberPortalAdditionalInfoIframesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityMemberPortalAdditionalInfoIframesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
