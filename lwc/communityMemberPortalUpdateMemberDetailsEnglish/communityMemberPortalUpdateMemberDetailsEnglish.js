...
import { OMNIDEF } from './communityMemberPortalUpdateMemberDetailsEnglish_def.js';
import tmpl from './communityMemberPortalUpdateMemberDetailsEnglish.html';
import tmpl_nds from './communityMemberPortalUpdateMemberDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityMemberPortalUpdateMemberDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
