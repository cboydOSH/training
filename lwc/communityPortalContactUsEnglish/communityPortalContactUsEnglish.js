...
import { OMNIDEF } from './communityPortalContactUsEnglish_def.js';
import tmpl from './communityPortalContactUsEnglish.html';
import tmpl_nds from './communityPortalContactUsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityPortalContactUsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
