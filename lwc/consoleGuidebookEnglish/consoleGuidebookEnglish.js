...
import { OMNIDEF } from './consoleGuidebookEnglish_def.js';
import tmpl from './consoleGuidebookEnglish.html';
import tmpl_nds from './consoleGuidebookEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class consoleGuidebookEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
