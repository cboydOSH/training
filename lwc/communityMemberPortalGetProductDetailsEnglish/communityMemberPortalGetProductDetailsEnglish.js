...
import { OMNIDEF } from './communityMemberPortalGetProductDetailsEnglish_def.js';
import tmpl from './communityMemberPortalGetProductDetailsEnglish.html';
import tmpl_nds from './communityMemberPortalGetProductDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityMemberPortalGetProductDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
