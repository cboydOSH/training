...
import { OMNIDEF } from './communityMemberPortalKnowledgeSearchEnglish_def.js';
import tmpl from './communityMemberPortalKnowledgeSearchEnglish.html';
import tmpl_nds from './communityMemberPortalKnowledgeSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityMemberPortalKnowledgeSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
