...
import { OMNIDEF } from './communityMemberPortalUpdatePaymentInformationEnglish_def.js';
import tmpl from './communityMemberPortalUpdatePaymentInformationEnglish.html';
import tmpl_nds from './communityMemberPortalUpdatePaymentInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityMemberPortalUpdatePaymentInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
