...
import { OMNIDEF } from './communityMemberPortalGuidebookEnglish_def.js';
import tmpl from './communityMemberPortalGuidebookEnglish.html';
import tmpl_nds from './communityMemberPortalGuidebookEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class communityMemberPortalGuidebookEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
